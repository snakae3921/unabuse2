...
<!-- add column start -->
                        <div class="form-group row">
                            <label for="postno" class="col-md-4 col-form-label text-md-right">{{ __('POST NO') }}</label>

                            <div class="col-md-6">
                                <input id="postno" type="text" class="form-control @error('postno') is-invalid @enderror" name="postno" value="{{ old('postno') }}" required autocomplete="postno">
